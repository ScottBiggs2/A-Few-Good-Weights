...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=Path,
        default=None,
        help="Markdown file to rewrite between export markers",
    )
    ap.add_argument(
        "--tail-rows",
        type=int,
