#!/usr/bin/env python3
r"""Figures for src/analysis/certifiability_margins.py.
...
type system. For Computer Modern math, pass ``--mathtext cm``.
...
def write_table_view(cells: Sequence[Cell], rho: float, out_dir: Path) -> Path:
    """Non-visual path to the same numbers (accessibility + direct quoting)."""
    lines = [
