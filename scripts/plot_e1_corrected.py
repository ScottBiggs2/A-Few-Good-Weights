"""
Figures for the corrected-builder E1 rerun.
...
Colour follows one consistent convention: warm masks are a single-hue ordinal
...
OUT = os.path.join(os.path.dirname(__file__), "..", "outputs", "e1_figures")
