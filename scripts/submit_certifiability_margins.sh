...
#
# Cells are defined below; pick one with CELL=<name>. Paths point at the surviving run artifacts for
...
#
# NEVER point OUT_DIR at $HOME — the magnitude caches are ~30 GB each and home quotas are typically far smaller.
...
case "$CELL" in
  ...
  olmo3_7b_lr1)
    ...
    # Deltas exist for steps 50..500; the default grid is 50..200.
    MILESTONES="${MILESTONES:-50,100,150,200}"
    ;;
  *)
