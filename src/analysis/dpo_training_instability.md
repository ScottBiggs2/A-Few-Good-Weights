...
One hypothesis was that dense gradients entering the network hit a sparse layer, become sparse thereafter, and corrupt downstream dense layers such as attention.
