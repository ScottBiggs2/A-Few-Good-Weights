...
Kept as-is so previously generated artifacts still reproduce; its magnitude
...
Can be run directly, or sharded across jobs via --shard-index/--shard-count
(see scripts/run_mask_score_gap_plots.sh for the reporting side).
"""
